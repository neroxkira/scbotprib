...
if (isBanned) return freply(mess.banned)
freply(`━━━━━ *INFO BOT* ━━━━━
❏ BASE ORI : NiorR Official
❏ TYPE SC : nodejs
❏ DI BUAT PADA : sel, 29, mart, 2022
❏ GITHUB CREATOR : https://github.com/JuniorGanteng
❏ YT CREATOR : https://youtube.com/channel/UCm1Wc9xSv6eWyPMFXfqU9bQ
*━━━━━━━━━━━━━━━━━━━━*`)
randommusic = fs.readFileSync(`./media/audio/${randomaudio}.mp3`)
Ramdani.sendMessage(from, randommusic, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
...
if (isBanned) return freply(mess.banned)
freply(`━━━━━ *SCRIPT* ━━━━━
❏ LINK VIA GITHUB : https://github.com/JuniorGanteng
❏ BASE ORI : NiorR
❏ TYPE SC : nodejs
❏ DI BUAT PADA : sel, 29, mart, 2022
*━━━━━━━━━━━━━━━━━━━━*`)
...
break
      ...
      qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
               ...
               buttonsMessage = {
               contentText: `${qris}`,
               footerText: '©NiorR Wangsaf', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/62895622624065?text=bang+mau+order+jasa+run+heroku:v`)
break
//JASA UP HEROKU
case 'jasaupgithub':
case 'jasaup':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/62895622624065?text=bang+mau+order+jasa+up+github:v`)
break
//STORE MENU//
//TOP UP GAME
case 'topupgame2':
...
// SOSMET          
      ...
      if (!isRegist) return freply(mess.regist)
      if (isBanned) return freply(mess.banned)
             freply(`Follow Instagram Owner Ya : https://www.instagram.com/ljuniorysj_`)
             break
//casee nya
case 'grupbot':
case 'groupbot':
...
"groupInviteMessage": {
"groupJid": "62895622624065-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": "162533333338378",
"groupName": `NiorR Official ~ 404 ${danz}`,
...
"businessOwnerJid": "62895622624065@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
//------------------< Lainnya >-------------------
      ...
      case 'caripesan':
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('62895622624065@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
